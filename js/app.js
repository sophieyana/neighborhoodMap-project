...
var initialLocations = [
    ...
    {title: 'British Museum', location: {lat:51.519593, lng:-0.126946}},
    {title: 'National Gallery', location: {lat:51.509149, lng:-0.128278}},
    {title: 'National Portrait Gallery, London', location: {lat:51.509410, lng:-0.128143}},
...
var ViewModel = function () {
  ...
  self.search = ko.computed(function() {
      ...
      return ko.utils.arrayFilter(self.viewList(), function(location) {
              var match=location.title.toLowerCase().indexOf(self.query().toLowerCase())>= 0;
